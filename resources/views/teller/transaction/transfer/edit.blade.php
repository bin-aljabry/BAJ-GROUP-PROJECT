                ...
                <div class="card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('cashier.transfer.index') }}" class="btn btn-info btn-sm">Back</a>
                        </div>
                    </div>
                    <form class="needs-validation" novalidate action="{{ route('cashier.transfer.update', $data) }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="teller_name" name="teller_name"
                                            placeholder="Enter Branch name" required value="{{ $data->date }}">
                                    </div>
