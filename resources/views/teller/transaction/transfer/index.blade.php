    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('cashier.transfer.create') }}" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($data as $float)
                        <tr>
                            ...
                            <td><a href="{{ route('cashier.transfer.edit', encrypt($float->id)) }}"
                                    class="btn btn-sm btn-primary">Edit</a></td>
                            <td>
                                <form action="{{ route('cashier.transfer.destroy', encrypt($float->id)) }}"
