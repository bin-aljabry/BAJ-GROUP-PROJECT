    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('cashier.balance.create') }}" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($data as $transaction)
                        <tr>
                            ...
                            <td><a href="{{ route('cashier.balance.edit', encrypt($transaction->id)) }}"
                                    class="btn btn-sm btn-primary">Edit</a></td>
                            <td>
                                <form action="{{ route('cashier.balance.destroy', encrypt($transaction->id)) }}"
