                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('cashier.expenses_category.index') }}"
                                class="btn btn-sm btn-dark">Back</a>
                        </div>
                    </div>
                    <!-- /.card-header -->

                        <form action="{{ route('cashier.expenses_category.update',$data) }}" method="POST" class="needs-validation" novalidate="">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="name">Expended Name</label>
